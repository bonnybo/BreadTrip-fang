...
//    [_navgationTabBar addSubview:_line];
    ...
    _line = [[UIImageView alloc] initWithFrame:CGRectMake(2.0f, NAV_TAB_BAR_HEIGHT - 35.0f, width - 4.0f, 25.0f)];
    _line.image = [UIImage imageNamed:@"bar.png"];
    _line.alpha = 0.5;
    _line.layer.cornerRadius = 15.0;
...
//        [button setTitleShadowColor:[UIColor colorWithPatternImage:[UIImage imageNamed:@"bar.png"]]  forState:UIControlStateNormal];
